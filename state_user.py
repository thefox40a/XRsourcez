...
CHANNELS_STR = f"𓆩 **[XR Multi HUNTER](t.me/XRource)** **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = f"𓆩 **[XR Multi HUNTER](t.me/XRource)** **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = f"𓆩 **[XR Multi HUNTER](t.me/XRource)** **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = f"𓆩 **[XR Multi HUNTER](t.me/XRource)** **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = f"𓆩 **[XR Multi HUNTER](t.me/XRource)** **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = f"𓆩 **[XR Multi HUNTER](t.me/XRource)** **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"

@XR.on(events.NewMessage(outgoing=True, pattern=r"\.احصائياتي"))
async def count(event):
    ...
    dialogs = await XR.get_dialogs(limit=None, ignore_migrated=True)
    for d in dialogs:
    ...
    result += f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 XR **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
...
@XR.on(events.NewMessage(outgoing=True, pattern=r"\.معلوماتي"))
async def stats(event):
    ...
    response = f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 XR **- 🝢 - معلومات {full_name}** 𓆪\n"
...
@XR.on(events.NewMessage(outgoing=True, pattern=r"\.قنواتي (الكل|ادمن|مالك)"))
async def stats(event):
...
@XR.on(events.NewMessage(outgoing=True, pattern=r"\.كروباتي (الكل|ادمن|مالك)"))
async def stats(event):  
    catcmd = event.pattern_match.group(1)
    catevent = await event.edit(STAT_INDICATION)
    start_time = time.time()
